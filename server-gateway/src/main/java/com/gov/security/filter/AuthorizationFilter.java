package com.gov.security.filter;
...
public class AuthorizationFilter extends ZuulFilter {
    ...
    public Object run() throws ZuulException {
        ...
        if(isNeedAuth(request)){
            ...
            if(tokenInfo != null && tokenInfo.isActive()){//不为空且为激活状态
                ...
                //if(!StringUtils.startsWith(request.getRequestURI(),"/token") || StringUtils.startsWith(request.getRequestURI(),"/res")){
    ...
    private boolean isNeedAuth(HttpServletRequest request) {
        return (!StringUtils.startsWith(request.getRequestURI(),"/token") && !StringUtils.startsWith(request.getRequestURI(),"/res"));
    }
}
